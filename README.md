...
| 검색 기능, 찜 기능 구현, 메모 추가 기능 구현  | 2022.09.17 ~ 2022.09.19 | 페이지네이션을 통해 API 호출
데이터 스키마 구상 후 Realm을 이용해 찜 데이터 저장, 삭제 기능, 메모 저장 기능 구현 |
| 메모 및 이미지  수정, 삭제, 저장 기능, 홈 탭 기능 구현 | 2022.09.20 ~ 2022.09.22 | FileManage로 Document에 접근해 이미지 저장, 수정 ,삭제 기능 구현, 메모 수정, 삭제 기능 구현
